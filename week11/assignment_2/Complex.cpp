...
Number *Complex::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
            ...
            float _val1 = other->val() + value.first;
	    float _val2 = value.second;
            delete(this);
            delete(other);
            return new Complex(_val1, _val2);
	    ...
	    float _val2 = value.second;
            ...
            float _val1 = other->val().first + value.first;
	    float _val2 = other->val().second + value.second;
            delete(this);
            delete(other);
            return new Complex(_val1, _val2);
    } else {
...
Number *Complex::mul(Number * num) {
    ...
    if (num->types() == INTEGER) {
            Integer * other = dynamic_cast<Integer*>(num);
            float _val1 = other->val() * value.first;
            float _val2 = other->val() * value.second;
            delete(this);
            delete(other);
            return new Complex(_val1, _val2);
            ...
            Complex * other = dynamic_cast<Complex*>(num);
            float _val1 = (value.first * other->val().first) - (value.second * other->val().second);
            float _val2 = (value.first * other->val().second) + (value.second * other->val().first);
            delete(this);
            delete(other);
            return new Complex(_val1, _val2);
    } else {
